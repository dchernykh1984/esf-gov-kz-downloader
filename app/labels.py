...
_LABELS: dict[str, tuple[str, str | None]] = {
    ...
    # Goods table. Captions are kept terse: at twelve columns on one landscape
    # page there is no room for the full wording of the official blank.
    "row_no": ("№", "№"),
    "description": ("Наименование ТРУ", "ТЖҚ атауы"),
    "unit": ("Ед. изм.", "Өлш. бір."),
    "quantity": ("Кол-во", "Саны"),
    "unit_price": ("Цена", "Бағасы"),
    "price_without_tax": ("Без НДС", "ҚҚС-сыз"),
    "excise_amount": ("Акциз", "Акциз"),
    "turnover_size": ("Оборот", "Айналым"),
    "nds_rate": ("НДС, %", "ҚҚС, %"),
    "nds_amount": ("НДС", "ҚҚС"),
    "price_with_tax": ("С НДС", "ҚҚС-пен"),
